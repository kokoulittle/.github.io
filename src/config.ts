...
export const siteConfig: SiteConfig = {
  ...
  aboutMe:
    [
      "Bonjour, je m'appelle Jacques Wemegan.", 
      "Je suis passionné par la science des données et je développe actuellement un portefeuille de projets à la croisée de l'analyse et de la finance. J'ai récemment suivi une formation officielle en science des données à Cambridge ICE, où j'ai acquis une expérience pratique dans le domaine de l'apprentissage automatique, du traitement du langage naturel et de l'analyse de données.", 
      "Mon travail couvre l'analyse des sentiments dans les prévisions de séries chronologiques, l'exploration de textes financiers, avec un accent particulier sur l'extraction d'informations exploitables pour les secteurs bancaire et financier.",
